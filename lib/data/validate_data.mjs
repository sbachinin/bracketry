    ...
    all_rounds_data.forEach(round => {
        ...
        round.matches?.forEach(match => {
            ...
            match.sides.forEach?.(side => {
                ...
                // if (options.nationalities_visibility !== visibility_options.NEVER && typeof side.nationality_code !== 'string') {
                //     shout(`You set 'nationalities_visibility' option to true but didn't provide nationality: `, side)
                // }
