    ...
    all_rounds_data.forEach(round => {
        ...
        round.matches?.forEach(match => {
            ...
            match.sides.forEach?.(side => {
                ...
                // if (options.should_draw_nationalities !== 'Never' && typeof side.nationality_code !== 'string') {
                //     shout(`You set 'should_draw_nationalities' option to true but didn't provide nationality: `, side)
                // }
