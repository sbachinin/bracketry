    ...
    all_rounds_data.forEach(round => {
        ...
        round.matches?.forEach(match => {
            ...
            match.sides.forEach?.(side => {
                ...
                if (typeof side.flag_url !== 'undefined') {
                    if (typeof side.flag_url === 'string') {
                        !flag_urls.includes(side.flag_url) && flag_urls.push(side.flag_url)
                    } else {
                        halt('If side.flag_url is provided, it must be a string: ', side)
                    }
                }
