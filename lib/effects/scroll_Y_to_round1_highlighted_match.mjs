...
export const scroll_Y_to_round1_highlighted_match = (
    ...
    if ((match_center_scroll_Y + height_per_match/2 + options.main_vertical_padding) > canvas_height) {
        destination_scroll_Y = (
            store.state.scroll_Y
            + (match_center_scroll_Y + height_per_match/2 + options.main_vertical_padding - canvas_height)
                / round0_height_deficit * 100
        )
    }
