    ...
    // adjust scroll position to keep the same matches in the middle
        ...
        [HIGHLIGHT_TEAM_TITLES]: () => {
            const titles_to_unhighlight = [
                ...matches_scrollable_area.querySelectorAll('.player-title-item.highlighted')
            ]
            ...
            const titles_to_higlight = [
                ...matches_scrollable_area.querySelectorAll(`.player-title-item[team-id="${store.state.highlighted_team_id}"]`)
            ]
