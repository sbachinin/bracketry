...
import { draw_highlighted_line } from '../draw/highlighted_line.mjs'
...
export const get_effects = (
    ...
    const {
        main_canvas_el, expand_canvas_el, round_titles_canvas_el, highlight_canvas_el
    } = root_elements
    ...
    return {
        ...
        [REDRAW_HIGHLIGHT]: () => {
            draw_highlighted_line(all_data.rounds, store.state, options, highlight_canvas_el)
        },
