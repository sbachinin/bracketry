    ...
    return {
        ...
        [HIGHLIGHT_TEAM_TITLES]: () => {
            ...
            const titles_to_unhighlight = [
                ...stable_elements.matches_scrollable_area.querySelectorAll('.team-title-item.highlighted')
            ]
            ...
            const titles_to_higlight = [
                ...stable_elements.matches_scrollable_area.querySelectorAll(`.team-title-item[team-id="${highlighted_team_id}"]`)
            ]
