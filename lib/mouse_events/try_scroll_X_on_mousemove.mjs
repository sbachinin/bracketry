...
const get_scroll_force = (root_el_width, mouse_event, mousemove_horizontal_scroll_speed) => {
    const percent_from_left = mouse_event.offsetX / root_el_width * 100
...
export const try_scroll_X_on_mousemove = (
    ...
    scroll_force = get_scroll_force(e.target.clientWidth, e, mousemove_horizontal_scroll_speed)
    if (scroll_force === 0) {
        stop_running_every_frame()
        return
    }
