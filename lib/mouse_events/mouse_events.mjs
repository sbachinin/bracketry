...
import { handle_buttons_clicks } from './handle_buttons_clicks.mjs'
...
export const install_mouse_events = (
    ...
    root_elements.wrapper.addEventListener('mouseup',
        e => {            
            ...
            } else if (root_elements.hor_buttons !== null) {
                handle_buttons_clicks(e, root_elements.hor_buttons, all_data, store, options)
            }
    ...
    root_elements.main_canvas_el.addEventListener('mouseleave', e => maybe_stop_drag(e, all_data.all_content_width, store, options))
}
