...
export const install_mouse_events = (
    ...
    main_canvas_el.addEventListener("mousedown", e => start_dragging(e, store));
    main_canvas_el.addEventListener('mouseup', e => handle_drag_stop(e, store, options))
    main_canvas_el.addEventListener('mouseleave', e => handle_drag_stop(e, store, options))
}
