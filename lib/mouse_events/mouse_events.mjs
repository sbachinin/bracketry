...
export const install_mouse_events = (
    ...
    root_brackets_el.addEventListener(
        ...
        e => {
            ...
            if (options.highlight_team_history_on_click) {
                try_highlight_team(e, all_data.rounds, state, options, update_state,
    ...
    root_brackets_el.addEventListener('wheel', get_wheel_handler(all_data, options, state, update_state))
}
