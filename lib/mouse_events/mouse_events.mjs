...
export const install_mouse_events = (
    ...
    root_brackets_el.addEventListener(
        ...
        e => {
            ...
            maybe_drag(e, all_data.rounds, store, options)
        }
    )
    ...
    main_canvas_el.addEventListener("mousedown", e => maybe_start_dragging(e, store, options));
    main_canvas_el.addEventListener('mouseup', e => maybe_stop_drag(e, store, options))
    main_canvas_el.addEventListener('mouseleave', e => maybe_stop_drag(e, store, options))
}
