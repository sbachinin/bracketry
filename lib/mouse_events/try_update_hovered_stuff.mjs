...
export const try_update_hovered_stuff = throttle_with_trailing((e, all_data, store, options) => {
    if (!options.highlight_team_history_on_click) return

    const {
        hovered_team, hovered_match
    } = find_what_under_cursor(e, all_data, store.state.scroll_X, store.state.scroll_Y, options)
