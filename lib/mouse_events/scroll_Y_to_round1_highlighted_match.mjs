...
export const scroll_Y_to_round1_highlighted_match = (
    ...
    const round0_highlighted_match_index = rounds[0].matches.findIndex(m => m.sides.find(s => s.id === highlighted_team_id))
    const match_center_scroll_Y = get_match_center_scroll_Y(rounds[0], store.state.scroll_Y, round0_highlighted_match_index)
