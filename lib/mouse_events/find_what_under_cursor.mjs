import { get_match_body_height, get_match_middle_Y } from '../utils/sizes.mjs'
...
export const find_what_under_cursor = (e, all_data, state, options) => {
    ...
    const hovered_match_index = hovered_round?.matches.findIndex((m, m_i) => {
        const match_center_scroll_Y = get_match_middle_Y(all_data, hovered_round_index, m_i, state, options)
