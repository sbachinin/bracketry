...
export const get_root_el_height = (user_wrapper, options) => {
    if (user_wrapper.offsetHeight - get_round_title_height(options) < MAIN_CANVAS_MIN_HEIGHT) {
        return get_round_title_height(options) + MAIN_CANVAS_MIN_HEIGHT
    }
    return options.auto_canvas_height ? 'auto' : '100%'
}