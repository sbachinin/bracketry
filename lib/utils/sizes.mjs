...
export const get_max_scroll_round_index = (root_elements, all_data, state) => {
    const visible_rounds_count = root_elements.content_horizontal_scroller.clientWidth / state.first_round_width
