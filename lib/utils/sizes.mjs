...
export const get_max_scroll_round_index = (stable_elements, all_data, state) => {
    const visible_rounds_count = stable_elements.content_horizontal_scroller.clientWidth / state.first_round_width
