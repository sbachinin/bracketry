...
export const measure_widths = (rounds, options, ctx) => {
    ...
    const round_width = options.match_padding_left
        + (options.entry_status_visibility === 'all_rounds' && !is_match_reduced ? options.entry_status_width : 0)
    ...
    if (options.entry_status_visibility === 'first_round' && !is_match_reduced) {
