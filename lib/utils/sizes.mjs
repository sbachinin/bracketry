export const get_single_score_width = ({ main_score, tie_break }, options, ctx) => {
    ctx.save()
    ...
    if (tie_break !== undefined) {
        ctx.font = `bold ${options.score_size/1.6}px ${options.score_font_family}`;
...
export const get_single_player_scores_width = (score, options, ctx) => {
    return score
        .map(single_score => {
            return (
                get_single_score_width(single_score, options, ctx)
