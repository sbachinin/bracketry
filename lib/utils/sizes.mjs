...
export const get_round_title_left_X = (round_scroll_left_X, width_per_round, options) => {
    switch (options.round_title_text_align) {
        case 'left': return round_scroll_left_X + options.round_title_hor_margin
        case 'center': return round_scroll_left_X + width_per_round/2
        case 'right': return round_scroll_left_X + width_per_round - options.round_title_hor_margin
    }
}
...
export const get_match_center_Y = (all_data, round_index, match_index, state, options) => {
    ...
    const pixel_distance_from_anchor = all_data.rounds[round_index].static_left_X - state.scroll_X
