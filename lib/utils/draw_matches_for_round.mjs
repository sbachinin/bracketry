...
export const drawMatchesForRound = (roundIndex, allRounds, ctx, options) => {
    allRounds[roundIndex].matchesToDraw.forEach((match_data, matchIndex) => {
        // ctx.fillRect(
        ...
        ctx.moveTo(
            match_data.positionX + constants.ROUND_WIDTH - constants.MATCH_HOR_MARGIN,
            match_data.centerY
        );
