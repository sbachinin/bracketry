...
export const create_navigation = (root_id, get_option) => {
    ...
    return {
        ...
        get_state: () => {
            const html_shell = get_elements(root_id)
            if (html_shell === null) return {}
            return {
                reachedRightEdge: !html_shell.matches_positioner.lastChild?.classList.contains('hidden'),
                allRoundsAreVisible: html_shell.matches_positioner.querySelector('.round-wrapper.hidden') === null,
