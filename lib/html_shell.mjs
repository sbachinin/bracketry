    ...
    const the_root_element = create_element_from_Html(`
        <div class="playoffs-root">
            <div class="buttons-header">
                <div class="navigation-button left">
                    <div class="button-icon-wrapper"></div>
                </div>
                <div class="navigation-button right">
                    <div class="button-icon-wrapper"></div>
                </div>
            </div>
            <div class="all-but-buttons-header">
                <div class="navigation-button non-header-button left">
                    <div class="button-icon-wrapper"></div>
                </div>
                ...
                <div class="navigation-button non-header-button right">
                    <div class="button-icon-wrapper"></div>
                </div>
            </div>
        </div>
