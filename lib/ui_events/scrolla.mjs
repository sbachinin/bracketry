...
const get_scrollY_ratio = (html_shell, synthetic_scrollTop, get_option) => {
...
export const create_scrolla = (html_shell, get_option) => {
    ...
    return {
        get_scrollY_ratio: () => get_scrollY_ratio(html_shell, synthetic_scrollTop, get_option),

        adjust_offset: (scrollY_middle_ratio) => {
            synthetic_scrollTop = adjust_offset(scrollY_middle_ratio, html_shell, get_option, synthetic_scrollTop)
        },
