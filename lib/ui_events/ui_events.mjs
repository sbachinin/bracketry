...
import { enable_scroll, disable_scroll, handle_vertical_button_click } from './scroll.mjs'
...
export const install_ui_events = (
    ...
    const unhandle_vertical_button_click = handle_vertical_button_click(html_shell)
