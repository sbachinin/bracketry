...
export const create_horizontal_scroll_buttons = (
    ...
    const handle_new_round_index = new_index => {
        ...
        const width_deficit = get_all_content_width(options, rounds_count, round_width)
        ...
        if (new_index > 0) {
            destination_scroll_X = -Math.min(
                width_deficit,
                get_round_left_X(options, new_index, round_width) - options.distance_between_rounds/2
            )
        }
