...
export const draw_rounds = (
    ...
    for (let i=all_data.rounds.length-1; i>=0; i--) {
        const original_index = all_data.rounds.length - 1 - i
        const { left_X } = all_data.rounds[original_index]
        const round_width = all_data[original_index === 0 ? 'first_round_width' : 'round_width']
