...
export const draw_dynamic_matches = (
    ...
    const anchor_height_per_match = Math.max(
        ...
        (main_canvas_el.height - options.main_vertical_padding * 2) / anchor_round.matches.length
    )

    const full_anchor_round_height = anchor_round.matches.length * anchor_height_per_match + options.main_vertical_padding * 2
    const anchor_round_height_deficit = full_anchor_round_height - main_canvas_el.height
