...
export const draw_lines_for_match = (all_data, round_index, match_index, round_scroll_X, center_Y, state, options, ctx) => {
...
// draw 'axis' of the match
    ...
    const upper_parent = all_data.rounds[round_index - 1]?.matches[match_index*2]
    const lower_parent = all_data.rounds[round_index - 1]?.matches[match_index*2 + 1]
