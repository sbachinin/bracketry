...
export const draw_teams_titles = (
    ...
    ctx.textAlign = 'left'
    ctx.fillStyle = sides[0].id === selected_team_id ? options.highlighted_team_text_color : options.team_title_text_color
    ...
    ctx.fillStyle = sides[1].id === selected_team_id ? options.highlighted_team_text_color : options.team_title_text_color
