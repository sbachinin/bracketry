...
const draw_highlighted_line_for_match = ({
    ...
    const round_left_X = stable_elements.rounds_elements_wrapper.firstChild.clientWidth * round_index
...
export const maybe_draw_highlighted_line = (
    ...
    const { lines_canvas: canvas, rounds_elements_wrapper: rounds_el } = stable_elements
    ...
    const rightmost_highlighted_left_X = rounds_el.firstChild.clientWidth * rightmost_highlighted.round_index

    ctx.moveTo(
        rightmost_highlighted_left_X
            + rounds_el.firstChild.clientWidth
