import { get_match_middle_Y, get_round_width } from '../utils/sizes.mjs'
...
const draw_highlighted_line_for_match = ({
    ...
    const round_left_X = round_width * round_index
    ...
    if (round_index > 0) {
        ...
        const upper_parent = {
            ...
            is_highlighted: !!upper_parent_original.sides.find(s => s.id === highlighted_team_id)
        }
        ...
        const lower_parent = {
            ...
            is_highlighted: !!lower_parent_original.sides.find(s => s.id === highlighted_team_id)
        }
...
export const maybe_draw_highlighted_line = (
    ...
    if (typeof highlighted_team_id !== 'string') return
    ...
    const rightmost_highlighted = find_rightmost_highlighted_match(all_data.rounds, highlighted_team_id)
    ...
    const rightmost_highlighted_left_X = round_width * rightmost_highlighted.round_index
