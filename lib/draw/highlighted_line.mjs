import { get_match_middle_Y, get_width_per_round } from '../utils/sizes.mjs'
...
const draw_highlighted_line_for_match = ({
    ...
    const connection_point = [round.static_left_X + options.match_hor_margin, match.match_middle_Y]
...
export const draw_highlighted_line = ({
    ...
    ctx.moveTo(
        ...
        last_highlighted.match.match_middle_Y
    )
    ...
    if (last_highlighted.side.isWinner === false) {
        ...
        ctx.fillRect(
            last_highlighted.round.static_left_X
                ...
                - dot_size / 2,
            last_highlighted.match.match_middle_Y - dot_size / 2,
            dot_size,
            dot_size,
        )
    }
