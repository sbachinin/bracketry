...
const draw_highlighted_line_for_match = ({
    ...
    if (round_index > 0) {
        ...
        const upper_parent = {
            ...
            center_scroll_Y: get_match_center_scroll_Y(all_data, upper_parent_original.id, state.scroll_Y, options),
        ...
        const lower_parent = {
            ...
            center_scroll_Y: get_match_center_scroll_Y(all_data, lower_parent_original.id, state.scroll_Y, options),
...
export const draw_highlighted_line = ({
    ...
    Object.assign(last_highlighted.match,
        {center_scroll_Y: get_match_center_scroll_Y(
            all_data, last_highlighted.match.id, state.scroll_Y, options
        )}
    )
