...
export const draw_regular_match = ({
    ...
    if (highlighted_team_id) { // hide original non-highlighted match
        ...
        ctx.fillRect(left_X, match.center_Y - options.min_height_per_match/2, all_data.rounds[round_index].width - options.connection_lines_width, options.min_height_per_match)
    }
