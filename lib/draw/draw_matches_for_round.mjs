...
// draw 'axis' of the match
        ...
        ctx.moveTo(round_data.left_X + round_data.width - (options.connection_lines_type === 'curve' ? 20 : 4), center_Y)
        const connection_point = [round_data.left_X, center_Y]
...
// maybe draw an 'end of team history' rect, if loss
        /* if (team_to_highlight.isWinner === false) {
            ...
            ctx.fillRect(
                round_data.left_X + round_data.width - (options.connection_lines_type === 'curve' ? 20 : 0) - dot_size/2,
                center_Y - dot_size/2,
                dot_size,
                dot_size,
            )
...
// maybe draw higlighted 'axis' & connecting lines
        ...
        ctx.moveTo(round_data.left_X + round_data.width - (options.connection_lines_type === 'curve' ? 20 : 0), center_Y)
        ctx.lineTo(...connection_point)
        if (round_index > 0) {
