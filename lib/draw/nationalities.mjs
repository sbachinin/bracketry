...
export const should_draw_nationalities = (round_index, options) => {
    ...
    if (options.should_draw_nationalities === 'Never') return false
    if (options.should_draw_nationalities === 'At all rounds') return true
    if (options.should_draw_nationalities === 'At first round') return round_index === 0
}
