...
//
    draw_teams_titles(match.sides, team_title_left_X, match.center_Y, state.highlighted_team_id, options, ctx, true)

//
    draw_scores(ctx, match, scores_left_X, match.center_Y, options)
