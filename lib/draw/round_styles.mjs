...
export const get_rounds_styles = (root_id, options) => `
    ...
    #${root_id} .match-info-pair > div:not(.gap-btw-sides) {
    ...
    #${root_id} .gap-btw-sides {
        height: ${options.vertical_distance_between_teams}px;
    }
    
    #${root_id} .match-info-pair.nationalities {
        max-width: ${ options.match_root_font_size * 2 }px;
    }
