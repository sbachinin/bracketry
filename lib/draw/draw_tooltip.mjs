...
import { MATCH_PADDING_RIGHT, VERT_GAP_BTW_OPPONENTS } from '../constants.mjs'
...
export const draw_tooltip = ({
    ...
    const font_size = options.match_font_size
    ...
    const tooltip_center_Y = state.tooltip.side_index === 0
        ? center_scroll_Y - VERT_GAP_BTW_OPPONENTS / 2 - font_size * 1
        : center_scroll_Y + VERT_GAP_BTW_OPPONENTS / 2 + font_size * 1
    const tooltip_X = round_scroll_X + round.width - MATCH_PADDING_RIGHT
