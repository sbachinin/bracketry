...
export const should_draw_entry_status = (round_index, options) => {
    ...
    if (options.entry_status_visibility === 'never') return false
    if (options.entry_status_visibility === 'all_rounds') return true
    if (options.entry_status_visibility === 'first_round') return round_index === 0
}
