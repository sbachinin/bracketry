export const get_buttons_styles = (root_id, options) => {
    ...
    const buttons_are_gutters = options.nav_buttons_position === 'gutters'
    const buttons_are_before_titles = options.nav_buttons_position === 'beforeTitles'
    const buttons_are_over_titles = options.nav_buttons_position === 'overTitles'
    const buttons_are_hidden = options.nav_buttons_position === 'hidden'
