...
export const get_buttons_styles = (root_id, options) => {
    ...
    return `
        ...
        #${root_id} .buttons-header {
            height: ${options.default_scroll_button_size}px;
        ...
        #${root_id} .scroll-button.non-header-button {
            ...
            min-height: ${ buttons_are_gutters ? '100%' : options.default_scroll_button_size }px;
        }
        ...
        #${root_id} .default-scroll-svg {
            width: 100%;
            height: auto;
            padding: ${options.default_scroll_button_size / 8}px;
        }
    `
}