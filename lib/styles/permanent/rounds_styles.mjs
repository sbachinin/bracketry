...
/* highlighted lines */
    ...
    #${root_id} .matches-positioner:not(.with-entry-statuses) .side-info-item.entry-status {
        display: none;
    }
    ...
    #${root_id} .matches-positioner.with-nationalities .player-wrapper .nationality {
        display: flex;
    }
