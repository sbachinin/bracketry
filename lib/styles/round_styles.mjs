export const get_rounds_styles = (root_id, options) => `
    ...
    #${root_id} .match-body .match-status {
        ...
        z-index: 2;
        border: ${options.connectionLinesWidth}px solid ${options.connection_lines_color};
        padding: 2px 6px;
        align-self: center;
        margin-right: 2%;
    }
    ...
    #${root_id} .match-wrapper.highlighted .match-body .match-status {
        border-color: ${options.highlighted_connection_lines_color};
    }
    ...
    ${options.onMatchClick
        ? `
            ...
            #${root_id} .match-body:hover .player-title {
                color: ${options.highlighted_player_title_color};
            }
        `
        : ''
    }
...
/* regular lines */
    ...
    #${root_id} .match-wrapper.highlighted .match-lines-area .line-wrapper {
        color: ${options.highlighted_connection_lines_color}; /* for box-shadow color, not text */
    }

    #${root_id} .match-wrapper:nth-child(even) .line-wrapper.upper {
        box-shadow: ${options.connectionLinesWidth}px 0px 0px 0px;
        border-bottom: ${options.connectionLinesWidth}px solid ${options.connection_lines_color};
    }
    #${root_id} .match-wrapper:nth-child(odd) .line-wrapper.lower {
        box-shadow: ${options.connectionLinesWidth}px 0px 0px 0px;
        border-top: ${options.connectionLinesWidth}px solid ${options.connection_lines_color};
    }
...
/* highlighted lines */
    #${root_id} .match-wrapper.highlighted .line-wrapper {
        border-color: ${options.highlighted_connection_lines_color} !important;
    }
    ...
    #${root_id} .side-wrapper:last-of-type {
        ...
        padding-top: ${options.distance_from_match_axis + options.connectionLinesWidth}px;
    }
