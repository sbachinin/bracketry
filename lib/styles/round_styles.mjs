export const get_rounds_styles = (root_id, get_option) => `
    ...
    #${root_id} .round-wrapper:first-of-type {
        margin-left: ${get_option('matchHorMargin')}px; /* shrink the first round because he needs no left padding */
    }
    ...
    #${root_id} .match-body {
        width: 100%;
        margin-top: ${get_option('matchMinVerticalGap') / 2}px;
        margin-bottom: ${get_option('matchMinVerticalGap') / 2}px;
    ...
    #${root_id} .round-wrapper:last-of-type {
        margin-right: ${get_option('matchHorMargin')}px;
    }
