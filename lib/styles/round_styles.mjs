export const get_rounds_styles = (root_id, options) => `
    ...
    #${root_id} .round-wrapper:not(:first-of-type) .side-wrapper {
        margin-left: -${ options.connection_lines_width }px;
    }
...
/* match axis: upper body's border */
    #${root_id} .side-wrapper:first-of-type .side-body {
        border-bottom: ${ options.connection_lines_width }px solid ${ options.connection_lines_color };
    }
/* vertical ribs: wrapper's border */
    ...
    #${root_id} .match-wrapper:nth-child(odd) .side-wrapper:first-of-type .side-body,
    #${root_id} .match-wrapper:nth-child(even) .side-wrapper:last-of-type .side-body {
        /* otherwise the neighbour side's right border will cause horizontal misalignment */
        padding-right: ${ options.match_hor_margin + options.connection_lines_width }px;
    }
