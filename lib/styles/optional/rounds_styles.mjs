export const get_rounds_styles = (root_id, get_option) => `
    ...
    #${root_id} .round-wrapper .match-body:not(:empty) {
        border: ${get_option('connectionLinesWidth')}px solid transparent;
    }



    #${root_id} .matches-positioner .round-wrapper.collapsed {
        visibility: hidden;
        ${
...
/* regular lines */
    ...
    #${root_id} .round-wrapper:first-of-type .match-lines-area {
        left: ${get_option('matchHorMargin')}px;
    }
    #${root_id} .round-wrapper:last-of-type .match-lines-area {
