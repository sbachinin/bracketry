export const get_rounds_styles = (root_id, get_option) => `
    ...
    #${root_id} .match-body .sides {
        ...
        grid-row-gap: ${get_option('connectionLinesWidth')}px; /* if CLWidth is even, add a gap of 1px, otherwise two sides appear at different distance from axis */
    }
...
/* highlighted lines */
    ...
    #${root_id} .side-info-item.entry-status {
        width: ${get_option('matchFontSize') * get_option('entryStatusWidthRatio')}px;
    }
