export const get_buttons_styles = (get_option) => {
    ...
    return `
        ...
        ## .buttons-header {
            ...
            border-bottom-color: ${get_option('navigationGutterBorderColor')};
            ${
        ...
        ## .navigation-button.non-header-button.left {
            ...
            border-right-color: ${buttons_are_gutters ? get_option('navigationGutterBorderColor') : 'transparent'};
        }
        ## .navigation-button.non-header-button.right {
            background: ${get_option('rightNavigationButtonBackground')};
            border-left-color: ${buttons_are_gutters ? get_option('navigationGutterBorderColor') : 'transparent'};
        }
        ...
        ## .default-nav-icon svg {
            padding: ${get_option('defaultNavigationSvgSize') / 15}px;
            width: ${get_option('defaultNavigationSvgSize')}px;
            height: ${get_option('defaultNavigationSvgSize')}px;
        }
    `
}