...
export const createBrackets = (
    ...
    const handle_new_scrollY = new_scrollY => {
        state.scrollY = new_scrollY
        draw_all(all_data, state, canvas_el, actual_options)
    }
    ...
    install_mouse_events(all_data, actual_options, state, handle_new_scrollX, handle_new_scrollY, canvas_el)
}
