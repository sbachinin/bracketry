...
import { create_unique_id, deep_clone_object, is_valid_number, is_object } from './utils.mjs'
...
const apply_new_options = (
    ...
    if (!is_object(new_options)) {
        console.warn('options must be an object, instead got', typeof new_options)
    } else {
        validate_user_options(new_options)
        options_dealer.merge_new_options(new_options)
    }
