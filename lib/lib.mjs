...
import { try_add_flag_images } from './data/flags/try_add_flag_images.mjs'
...
export const createBrackets = (initial_data, user_wrapper_el, user_options) => {
    ...
    const root_elements = create_root_elements(user_wrapper_el, all_data.root_id, actual_options, update_all)
