...
import { create_scrolla } from './ui_events/scrolla.mjs'
...
export const createPlayoffs = (initial_user_data, user_wrapper_el, user_options) => {
    ...
    let html_shell = create_html_shell(user_wrapper_el, root_id, user_options?.fullscreen === true)
    apply_options(user_options, options_dealer, root_id, html_shell)
    ...
    let navigation = create_navigation(root_id, html_shell, options_dealer.get_final_value, scrolla)
