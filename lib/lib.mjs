...
const try_adjust_scrollX_on_resize = (
    ...
    const maximum_visible_width = (rounds_count * (round_width + distance_between_rounds)) + scrollX
...
export const createBrackets = (
    ...
    const handle_new_scrollX = new_scrollX => {
        ...
        draw_all(allData, state, canvasEl, actual_options)
    }
    ...
    new ResizeObserver(
        debounce(resizeEntry => {
            ...
            state.scrollX = try_adjust_scrollX_on_resize(
                ...
                allData.rounds.length,
                root_container_width,
                actual_options.round_width,
                actual_options.distance_between_rounds
            )
