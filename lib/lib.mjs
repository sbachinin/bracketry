...
export const createPlayoffs = (user_data, user_wrapper_el, user_options) => {
    ...
    store.update_state({
        anchor_round_index: get_initial_anchor_index(all_data, stable_elements, options_dealer.get_final_value)
    })
    ...
    observe_resize_later(
        user_wrapper_el,
        () => handle_round_index(all_data, options_dealer.get_final_value, store.state, stable_elements)
    )
...
// expose stuff
    return {
        ...
        moveToNRound: (n) => {
            ...
            try_update_anchor_round_index(new_index, all_data, store, stable_elements, options_dealer.get_final_value)
        },
        ...
        getNavigationState: () => {
            ...
            return {
                ...
                reachedRightEdge: (
                    get_max_anchor_round_index(stable_elements, all_data, options_dealer.get_final_value)
