...
import { has_reached_right_edge } from './utils/sizes.mjs'
...
import { try_update_base_round_index } from './navigation/try_update_base_round_index.mjs'
...
// expose stuff
    return {
        moveToPreviousRound: () => try_update_base_round_index(
            store.state.base_round_index-1,
            all_data,
            store,
            stable_elements),

        moveToNextRound: () => try_update_base_round_index(
            store.state.base_round_index+1,
            all_data,
            store,
            stable_elements),
        ...
        setCentralRoundIndex: (n) => {
            ...
            try_update_base_round_index(new_index, all_data, store, stable_elements)
        },

        setBaseRoundIndex: (n) => {
            try_update_base_round_index(n, all_data, store, stable_elements)
        },
        ...
        getNavigationState: () => {
            ...
            return {
                ...
                reachedRightEdge: has_reached_right_edge(stable_elements),
