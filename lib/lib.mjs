...
export const createPlayoffs = (user_data, user_wrapper_el, user_options) => {
    ...
    if (!merge_succeeded) {
        return { moveToPreviousRound: () => void 0, moveToNextRound: () => void 0, getNavigationState: () => void 0, applyNewOptions: () => void 0, applyAllData: () => void 0, applyMatchesUpdates: () => void 0 }
    }
...
// expose stuff
    return {
        ...
        applyMatchesUpdates: (matches_data) => {
            ...
            const { have_critical_error } = handle_data_errors(validate_matches(matches_data, all_data.contestants))
