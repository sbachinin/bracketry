...
const create_scroll_buttons = (the_root_element) => {
    ...
    return {
        ...
        update_innerHTML(options) {
            left.innerHTML = options.left_scroll_button_html
            top_left.innerHTML = options.left_scroll_button_html
            right.innerHTML = options.right_scroll_button_html
            top_right.innerHTML = options.right_scroll_button_html
        },
