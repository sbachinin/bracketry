...
const create_navigation_buttons = (stable_elements) => {
    ...
    return {
        ...
        update_active(stable_elements) {
            const left_is_active = parseInt(stable_elements.content_area.style.left) < 0
            const right_is_active = has_reached_right_edge(stable_elements)
