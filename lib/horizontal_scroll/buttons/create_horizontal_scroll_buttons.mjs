import { debounce, update_styles, insert_styles, get_main_canvas } from '../../utils/utils.mjs'
...
export const create_horizontal_scroll_buttons = (root_id, options) => {
    ...
    const update_visibility = debounce((all_data, options, scroll_X_anchor_round_index) => {
        const should_show = all_data.width_per_round * all_data.rounds.length > get_main_canvas().width
