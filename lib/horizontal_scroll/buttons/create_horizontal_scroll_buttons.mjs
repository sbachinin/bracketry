...
export const create_horizontal_scroll_buttons = (root_id, options) => {
    ...
    const update_visibility = debounce((all_data, options, anchor_round_index, root_elements) => {
        const should_show = root_elements.rounds_elements_wrapper.firstChild.clientWidth * all_data.rounds.length > root_elements.the_root_element.clientWidth
        ...
        const right_is_disabled = anchor_round_index >= get_max_scroll_round_index(root_elements, all_data, options)
