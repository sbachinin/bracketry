...
export const MATCH_OPTIONS = {
    ...
    draw_seed: {
        ...
        type: 'select',
        options: [ 'At first round', 'At all rounds', 'Never' ],
    ...
    hovered_match_border_color: {
        title: `Border color of a match on hover (if 'show scores only on hover')`,
        type: 'string',
        default_value: '#000'
    }
}
...
export const SCORES_OPTIONS = {
    show_scores_only_on_hover: {
        title: 'Show scores only on hover',
        type: 'switch',
        default_value: true
    },
    scores_left_margin: {
