...
export const MATCH_OPTIONS = {
    ...
    reduce_match_until_clicked: {
        ...
        type: 'switch',
        default_value: false,
        incompatible_with: ['reduce_match_until_hovered'/* , 'highlight_team_history_on_click' */]
    },
    ...
    reduce_match_until_hovered: {
        ...
        type: 'switch',
        default_value: false,
        incompatible_with: ['reduce_match_until_clicked'/* , 'highlight_team_history_on_click' */]
    },
    ...
    highlight_team_history_on_click: {
        ...
        type: 'switch',
        default_value: true,
        // incompatible_with: ['reduce_match_until_clicked', 'reduce_match_until_hovered']
    },
