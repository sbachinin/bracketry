...
export const get_initial_anchor_index = (all_data, stable_elements, first_round_width) => {
    ...
    const visible_rounds_count = stable_elements.content_horizontal_scroller.clientWidth / first_round_width
