...
// create root element
    ...
    main_canvas_wrapper.style.paddingRight = '100px' // to hide scrollbar
...
// create canvas for round titles
    ...
    round_titles_canvas_el.style.transition = 'all 0.3s ease-out 0s'
...
// create canvas
    ...
    main_canvas_el.style.marginLeft = 0
    main_canvas_el.style.transition = 'all 0.3s ease-out 0s'
