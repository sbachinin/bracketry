...
export const update_root_elements = (root_elements, options, all_data, state) => {
    const { the_root_element, main_canvas_wrapper, main_canvas_el, round_titles_canvas_el,
 ...
 */
    ...
    const main_canvas_width_px = main_canvas_wrapper.clientWidth
    main_canvas_el.width = main_canvas_width_px
...
// create hor scroll buttons, if they weren't
    ...
    if (options.hide_round_titles) {
        ...
        round_titles_canvas_el.width = main_canvas_width_px
        ...
        round_titles_canvas_el.style.marginLeft = options.horizontal_scroll_buttons_clickable_width + 'px'
    }

    highlight_canvas_el.width = main_canvas_width_px
    highlight_canvas_el.height = canvas_height
    highlight_canvas_el.style.top = get_round_title_height(options) + 'px'
    highlight_canvas_el.style.left = options.horizontal_scroll_buttons_clickable_width + 'px'
}
