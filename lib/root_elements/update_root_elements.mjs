...
// apply options for hor buttons
    ...
    left_clickable_area.style.minHeight = options.horizontal_scroll_button_size + 'px'
    ...
    right_clickable_area.style.minHeight = options.horizontal_scroll_button_size + 'px'
