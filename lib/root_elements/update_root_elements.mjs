...
// create vert scroll buttons, if they weren't
    ...
    the_root_element.style.height = get_root_el_height(the_root_element.parentElement, options)
    ...
    const {
        ...
        canvas_hor_margin,
        canvas_vert_margin
    } = measure_main_canvas(the_root_element, all_data, options)

    main_canvas_el.width = canvas_width
    main_canvas_el.height = canvas_height
    main_canvas_el.style.marginTop = canvas_vert_margin + 'px'
    main_canvas_el.style.marginLeft = canvas_hor_margin + 'px'
    ...
    if (options.hide_round_titles) {
        ...
        round_titles_canvas_el.width = the_root_element.clientWidth
        ...
        round_titles_canvas_el.style.marginLeft = canvas_hor_margin + 'px'
    }

    highlight_canvas_el.width = canvas_width
    highlight_canvas_el.height = canvas_height
    highlight_canvas_el.style.top = get_round_title_height(options) + canvas_vert_margin + 'px'
    highlight_canvas_el.style.left = canvas_hor_margin + 'px'
}
