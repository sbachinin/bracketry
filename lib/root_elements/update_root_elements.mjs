...
export const update_root_elements = (root_elements, options, all_data, state) => {
    ...
    const canvas_height = get_round_height(all_data.rounds[0], matches_scroller.clientHeight, options)
