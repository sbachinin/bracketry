...
const GENERAL_OPTIONS = {
    ...
    match_hor_margin: {
        title: 'Match horizontal margins (px)',
        type: 'number',
        default_value: 36,
        min_value: 0
    },
...
export const ROUND_TITLE_OPTIONS = {
    round_titles_height: {
        title: 'Round titles height (any units)',
        type: 'string',
        default_value: '50px'
    },
...
export const HORIZONTAL_SCROLL_OPTIONS = {
    ...
    scroll_buttons_top_distance: {
        title: 'Horizontal scroll buttons distance from content top (any units)',
        type: 'string',
        default_value: '50%',
    },
    ...
    horizontal_scroll_button_size: {
        title: 'Horizontal scroll buttons size (any units)',
        type: 'string',
        default_value: '50px',
        disable_if: options => options.auto_canvas_size
    },
