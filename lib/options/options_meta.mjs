...
export const MATCH_OPTIONS = {
    min_vert_margin_between_matches: {
        title: 'Minimal vertical margin between matches',
        type: 'number',
        default_value: 20,
    },
    ...
    get_flag_image_source: {
        ...
        default_value: null,
        explanation: `options.get_flag_image_source is a JavaScript function that translates nationality codes to images.
            If provided, this function will be called to draw team flags (if no flag_url provided for a team).
            This function accepts one parameter - nationality code which is a string.
            Sport-brackets will call this function with nationality_code property of a side that you specify in data.
            get_flag_image_source must return an CanvasImageSource object (https://developer.mozilla.org/en-US/docs/Web/API/CanvasImageSource).
            (Whatever you return from get_flag_image_source will become the first argument of canvas's drawImage function).
            
            Example:
            const get_flag_image_source_example = nationality_code => {
