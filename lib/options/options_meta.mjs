...
export const HORIZONTAL_SCROLL_OPTIONS = {
    ...
    left_scroll_button_icon: {
        ...
        default_value: `
            <svg class="default-scroll-svg" style="width: 100%; height: 100%;" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M16.67 0l2.83 2.829-9.339 9.175 9.339 9.167-2.83 2.829-12.17-11.996z"/></svg>
        `,
        disable_if: options => options.auto_canvas_size
    },
    right_scroll_button_icon: {
        ...
        type: 'multiline_string',
        default_value: `
            <svg class="default-scroll-svg" style="width: 100%; height: 100%;" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M5 3l3.057-3 11.943 12-11.943 12-3.057-3 9-9z"/></svg>
        `,
        disable_if: options => options.auto_canvas_size
    },
}
...
export const MATCH_OPTIONS = {
    min_height_per_match: {
        title: 'Minimal height per match, px',
        type: 'number',
        default_value: 70,
    },
