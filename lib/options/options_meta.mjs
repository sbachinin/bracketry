...
const GENERAL_OPTIONS = {
    ...
    match_hor_margin: {
        title: 'Match horizontal margins',
        type: 'number',
        default_value: 36,
        min_value: 0
    },
    ...
    auto_canvas_size: {
        ...
        type: 'boolean',
        default_value: false,
        explanation: explanations.auto_canvas_size
    },
}
...
export const HORIZONTAL_SCROLL_OPTIONS = {
    horizontal_scroll_buttons_position: {
        ...
        type: 'select',
        options: [ 'On top of canvas', 'In the gutters', 'Hidden' ],
        default_value: 'In the gutters',
        disable_if: options => options.auto_canvas_size
    },

    scroll_buttons_top_distance: {
        title: 'Horizontal scroll buttons distance from content top',
        type: 'number',
        default_value: '50',
        explanation: 'Expressed in % of content height. Not applied if "horizontal_scroll_buttons_position" option has a value "In the gutters"'
    },
...
export const MATCH_OPTIONS = {
    min_horizontal_distance_btw_matches: {
        title: 'Minimal horizontal distance between matches, px',
        type: 'number',
        default_value: 20,
    },

    match_width: {
        title: 'Match width, px',
        type: 'number',
        default_value: 300
    },

    vertical_distance_between_teams: {
        title: `Vertical distance between two sides of a match (even number)`,
        type: 'number',
        default_value: 3
    },
