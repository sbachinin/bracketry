...
export const CALLBACKS = {
    onMatchClick: {
        ...
        type: 'function_or_null',
        default_value: null,
        explanation: `Your function will be called with 1) data of a match that was clicked and 2) data of a round that contains this match.
...
4) data of a round within which a side was clicked
