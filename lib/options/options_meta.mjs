...
export const MATCH_OPTIONS = {
    ...
    show_winner_mark: {
        title: `Show winner mark if side.result === "winner"`,
        type: 'boolean',
        default_value: false
    },
...
export const FONTS_OPTIONS = {
    ...
    player_title_text_color: {
        title: 'Player title text color',
        type: 'string',
        default_value: '#000'
    },
    ...
    winner_is_bold: {
        title: `Apply { font-weight: bold } to players titles when side.result === "winner"`,
        type: 'boolean',
        default_value: true,
    }
}
