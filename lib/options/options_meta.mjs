...
const GENERAL_OPTIONS = {
    ...
    use_classical_layout: {
        title: 'Use classical matches layout',
        type: 'boolean',
        default_value: false,
        explanation: explanations.use_classical_layout,
...
export const HORIZONTAL_SCROLL_OPTIONS = {
    ...
    horizontal_scroll_duration: {
        title: 'Horizontal scroll duration',
        type: 'number',
        default_value: 300,
        disable_if: options => options.auto_canvas_size
    }
...
export const MATCH_OPTIONS = {
    ...
    winner_mark: {
        ...
        type: 'multiline_string',
        default_value: `
            <svg style="fill: #00a5de" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M9 21.035l-9-8.638 2.791-2.87 6.156 5.874 12.21-12.436 2.843 2.817z"/></svg>
        `,
    },
/* 
    match_font_size: {
