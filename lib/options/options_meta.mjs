...
export const NAVIGATION_OPTIONS = {
    ...
    scroll_buttons_top_distance: {
        ...
        type: 'string',
        default_value: '50%',
        disable_if: options => options.nav_buttons_position === BUTTONS_POSITIONS.gutters
    },
    ...
    scroll_gutter_border_color: {
        ...
        type: 'string',
        default_value: '#bbbbbb',
        // disable_if: options => options.nav_buttons_position !== BUTTONS_POSITIONS.gutters /* || options.auto_content_size */,
    ...
    horizontal_scroll_buttons_svg_color: {
        title: 'Navigation buttons color',
        type: 'string',
...
/* 
    horizontal_scroll_buttons_hor_margin: {
        ...
        default_value: 0,
        disable_if: options => options.auto_content_size
            || options.nav_buttons_position === BUTTONS_POSITIONS.gutters
    },
 */

    left_scroll_button_html: {
