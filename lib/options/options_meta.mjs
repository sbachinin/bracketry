...
export const MATCH_OPTIONS = {
    ...
    entry_status_visibility: {
        ...
        type: 'select',
        options: [
            { title: 'At all rounds', value: 'all_rounds' },
            { title: 'At first round', value: 'first_round' },
            { title: `Don't show, unless match is expanded on hover or click`, value: 'only_expanded_match' },
            { title: 'Never', value: 'never' }
        ],
        default_value: 'first_round'
    },
