...
import { is_object, user_agent_is_mobile } from '../utils/utils.mjs'


const _get_final_value = (name, user_options, flattened_meta, is_mobile) => {
...
export const create_options_dealer = () => {
    ...
    return {
        ...
        get_final_value: (name) => _get_final_value(name, user_options, flattened_meta, is_mobile),
