...
const update_the_DOM = (the_root_element, get_option) => {
    the_root_element.querySelectorAll('.navigation-button.left .button-icon-wrapper')
        .forEach(b => b.innerHTML = get_option('leftNavigationButtonHTML'))
    the_root_element.querySelectorAll('.navigation-button.right .button-icon-wrapper')
