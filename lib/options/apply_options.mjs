...
const feature_classes = {
    'with-scroll-buttons-over-matches': (o) => o.verticalScrollMode === 'buttons' && o.scrollButtonsPosition === 'overMatches',
    ...
    'with-buttons-vertical-scroll': (o) => o.verticalScrollMode === 'buttons',
