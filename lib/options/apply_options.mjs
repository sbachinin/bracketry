...
const update_the_DOM = (the_root_element, get_option) => {
    the_root_element.querySelector('.navigation-button.left')
        .innerHTML = get_option('leftNavButtonHTML')
    the_root_element.querySelector('.navigation-button.right')
        .innerHTML = get_option('rightNavButtonHTML')

    the_root_element.querySelector('.button-up')
        .innerHTML = get_option('scrollUpButtonHTML')
    the_root_element.querySelector('.button-down')
