...
// ensure min numbers
    ...
    if (!data_summary.have_entry_status) {
        Object.assign(actual_options, { entry_status_visibility: visibility_options.NEVER })
    }

    if (!data_summary.have_nationality) {
        Object.assign(actual_options, { nationalities_visibility: visibility_options.NEVER })
    }
}